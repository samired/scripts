...
attendees = ['Ahmed Ali Dahish', 'Ahmed Fawzy Sharabi', 'Ahmed Ismaeil Atito', 'Ahmed Muhammad Fawzy', 'Ahmed Osama Alghareb', 'Ayman Abd-Allah Moawad', 'Hebatullah Sayed Abdel Salam', 'Hossam Hossny Ahmed', 'Karim Salah-Eldin Ahmed', 'Mahmoud Fathy Abdel Fatah', 'Mahmoud Zidane Mohamed', 'Mohamed Awad Mohammed', 'Mohamed Hamdy Shedid', 'Mohamed Ibrahim Tawfik', 'Mohamed Makram Abdel Azim', 'Muhammad Magdi Hammam', 'Omar Fathy', 'Omar Sameh Mohamed', 'Yehia Mohamed Yehia']
